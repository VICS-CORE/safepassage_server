...
class AddressFactory(factory.django.DjangoModelFactory):
    ...
    #address_id = factory.Faker('integer')
    address_name = factory.Faker('street_address')
    address_streetline1 = factory.Faker('street_address')
    address_streetline2 = factory.Faker('street_address')
    address_streetline3 = factory.Faker('street_address')
    address_country = factory.Faker('country')
    address_state = factory.Faker('city')
    address_city = factory.Faker('city')
    address_zipcode = factory.Faker('random_number')
    address_latitude = factory.Faker('latitude')
    address_longitude = factory.Faker('longitude')
...
class UserFactory(factory.django.DjangoModelFactory):
    ...
    user_addressid = factory.Faker('random_number')
...
class OrganisationFactory(factory.django.DjangoModelFactory):
    ...
    organisation_address = factory.Faker('random_number')
...
class RolesFactory(factory.django.DjangoModelFactory):
    ...
    #user_id = models.AutoField(primary_key=True)
    #roles_orid = factory.SubFactory(OrganisationFactory)
    #roles_userid = factory.SubFactory(UserFactory)
    ...
    #roles_isvalid = factory.Faker('pybool')
    #roles_createdby = factory.SubFactory(UserFactory)
    #roles_updatedby = factory.SubFactory(UserFactory)
